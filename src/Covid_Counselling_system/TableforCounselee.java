...
public class TableforCounselee extends javax.swing.JFrame {
String path="jdbc:mysql://localhost:33066/Counselee";
String User="root";
String Password="root@Vaishnu";
    public TableforCounselee()
{
    initComponents();
    DisplayTable();
    }
private void DisplayTable(){
    ...
    String sql="select * from counselee.couprino";
    PreparedStatement pstmt = conn.prepareStatement(sql);
    String sql1="select * from counselee.counopri";
...
public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TableforCounselee.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TableforCounselee().setVisible(true);
            }
        });
    }
